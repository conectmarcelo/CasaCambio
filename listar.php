...
<table class='container table table-hover'>
  ...
  <h1 class="container" style="padding: 0px; margin-bottom: 20px;">Gerenciamento de Reservas<h1>
...
<?php
      ...
      $sql = "SELECT id,nome,cpf,telefone,moeda,quantidade FROM reserva";

      include('monta_tabela.php');
      include('fecha.php');
