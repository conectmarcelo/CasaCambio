...
<body>
  ...
  <div style="background-image: url(public/img/dinheiro.png); background-size: cover; background-repeat: no-repeat;">
    ...
    <?php include ('header.php');?>
      ...
      <div class="form col-sm-12 col-lg-4 " >
        ...
        <form>
          <h2 class="text-center">MOEDA EM ESPÉCIE</h2>
          ...
          <b><label>Escolha a quantia:</label><br>
            <input class="form-control" type="text" name="valor" size="10"  id="valor" ><br>

            <input type="Button" value="Cotação" onclick="cotar()" class="btn btn-primary btn-lg btn-block" ><br>
  ...
  <div style="background-color: #4B0082; float:left; padding: 50px;">
    ...
    <h4>Operando conosco você recebe um comprovante de transação que garante a origem de suas moedas, podendo ser apresentado para as autoridades aduaneiras caso necessário. 
    Compre sem riscos de notas falsas ou velhas. Não somos corretora. Somos agentes Banco Ourinvest Câmbio. Mais de 80 unidades no Brasil. 

    Principais moedas: 

    Dólar, euro, libra, peso chileno, argentino e mexicano, iene, franco suíço, yuan. 

    E muito mais em estoque para atender você!</h4>
